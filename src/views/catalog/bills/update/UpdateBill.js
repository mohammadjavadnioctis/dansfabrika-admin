            ...
            <CCard>
                ...
                <CCardBody>
                    ...
                    >
                        <CRow>
                            <CCol sm="6">
                                <CFormSelect onChange={e => setProccessType(e.target.value)} value={(processType!=null) ? processType : ""} name='proccess_type' label="İşlem Tipi:" required>
                            ...
                            <CCol sm="6">
                                <CFormSelect onChange={e => setProccess(e.target.value)} value={(process!=null) ? process : ""} name='proccess' label="İşlem:" required>
                                    <option value={0}>Seçiniz</option>
                                    <option value={1}>Admin</option>
                                    <option value={2}>Kullanıcı</option>
                                </CFormSelect>
