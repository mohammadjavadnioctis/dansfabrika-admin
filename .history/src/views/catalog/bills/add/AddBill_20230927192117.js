            ...
            <CCard>
                ...
                <CCardBody>
                  ...
                  {GetProcessTypeOptions()} 
                            ...
                            <CCol sm="6">
                            <CFormSelect onChange={e => setProccess(e.target.value)}  label="İşlem:" required>
                  <option value="">Seçiniz</option>
                  {GetProcessOptions()} 
                </CFormSelect>
                        ...
                        <CRow className='mt-4'>
                            ...
                            <CCol sm="6">
                                <CFormInput onChange={e => setPrice(e.target.value)} type='number'   step="0.1"  name='price' label='Fiyat' required></CFormInput>
                                <CFormFeedback invalid>Lütfen Fiyat Yazınız.</CFormFeedback>
                            </CCol>
                        </CRow>
